...
app.post('/api/projects', (req, res) => {
  ...
  db.run(
    ...
    function(err) {
      ...
      res.json({ _id: this.lastID.toString(), title, description, date, location, image, type, status });
    }
  );
});
...
app.post('/api/members', (req, res) => {
  ...
  db.run(
    ...
    function(err) {
      ...
      res.json({ _id: this.lastID.toString(), name, email, phone, position, image, bio });
    }
  );
});
...
app.post('/api/messages', (req, res) => {
  ...
  db.run(
    ...
    function(err) {
      ...
      res.json({ _id: this.lastID.toString(), name, email, phone, subject, message });
    }
  );
});
...
app.post('/api/gallery', (req, res) => {
  ...
  db.run(
    ...
    function(err) {
      ...
      res.json({ _id: this.lastID.toString(), title, image, description });
    }
  );
});
...
app.post('/api/about', (req, res) => {
  ...
  db.run(
    ...
    function(err) {
      ...
      res.json({ _id: this.lastID.toString(), name, emoji, type, year, event, institution, programs, established, description });
    }
  );
});
...
app.get('/db-status', (req, res) => {
  ...
  queries.forEach((query, index) => {
    ...
    db.get(query, (err, row) => {
      if (!err) results[table] = row.count;
      completed++;
